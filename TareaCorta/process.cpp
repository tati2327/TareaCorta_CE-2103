...
{
  //tatiana.add(1);
 // qDebug()<<"aaaaaaaaaaaaaaaaaaaaaaaaaaaaa"<<tatiana.size();
...
bool Process::applyProcess(List<Vehicule *>& process, int field, char _process) {
    ...
    Vehicule* temp = &*process.getData(field);
